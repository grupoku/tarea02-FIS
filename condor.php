...
<html>
<head>
	<title>Gimnasio Polideportivo Recoleta - Condor Rojas</title>
	<meta charset="utf-8">
...
<body style="background-image: url('images/CANCHA.png'); background-attachment: fixed; background-position: center;">
  <header>
    <div class="container">
    	<h1>Gimnasio Polideportivo Recoleta - Condor Rojas</h1>
    </div>
  </header>
  <div class="container">
      <!-- Botonera -->
      ...
      <div class="text-center col-md-12">
        <h2>Condor Rojas Norte</h2>
        <div class="col-md-offset-3 col-md-6" align="left" >
        <p>
                <h3>Condor Rojas Norte</h3>
                Recinto dedicado para la practica del futbol-sala en la Comuna de Recoleta
                <h4>Encargo: Juan Soto</h4>
                <h4>Equipamiento</h4>
                <ul>
                    <li> Posee de canchas de superficie sintetica con dimensiones de 20 x 40 mts </li>
                    <li>Capacidad 23.456 personas sentadas </li>
                    <li>6 camarines para los equipos </li>
                    <li>4 camarines para los arbitros</li>
                </ul>

        <h4>Informaciones: +56 9 3487 7623</h4>
      ...
      <div class="text-center col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <h2>Football</h2>
          <h3>Horario</h3>
          Lunes-Martes: 10:00-15:30hrs<br>
          Miercoles-Viernes: 11:00-19:30hrs<br>
          Sabado: 10:30-16:30hrs
        </p>
      </div>
